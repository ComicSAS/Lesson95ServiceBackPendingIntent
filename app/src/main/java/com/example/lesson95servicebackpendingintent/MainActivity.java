package com.example.lesson95servicebackpendingintent;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickStart(View v) {
        ...
        pi = createPendingResult(TASK1_CODE, piIntent, 0);
        ...
        pi = createPendingResult(TASK2_CODE, piIntent, 0);
        intent = new Intent(this, MyService.class).putExtra(PARAM_TIME, 4)
                .putExtra(PARAM_PINTENT, pi);
        startService(intent);

        pi = createPendingResult(TASK3_CODE, piIntent, 0);
